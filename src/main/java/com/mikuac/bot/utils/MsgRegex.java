...
public class MsgRegex {
    ...
    public final static String SE_TU = "^[来來发發给給]([1一])?[张張个個幅点點份]([Rr]18的?)?[色瑟][图圖]$|^setu(-[Rr]18)?$|^[色瑟][图圖](-[Rr]18)?$";

    public final static String WHAT_ANIME = "^(搜番模式)$";

    public final static String WHAT_ANIME_QUIT = "^(退出搜番模式)$";
